...
class _leveltwoState extends State<leveltwo> {
  ...
  Future<List<level3>> qwe() async {
    ...
    print(userid);
    final response =
    await http.get(Uri.parse(Apiconst.reflevel2+'$userid'));

    if (response.statusCode == 200) {


      final jsonData = json.decode(response.body)['level2'] as List<dynamic>;
      print(response);
      print(jsonData);
