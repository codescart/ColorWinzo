...
class _levelthreeState extends State<levelthree> {
  ...
  Future<List<level3>> qwe() async {
    ...
    print(userid);
    final response =
    await http.get(Uri.parse(Apiconst.reflevel3+'$userid'));

    if (response.statusCode == 200) {


      final jsonData = json.decode(response.body)['level3'] as List<dynamic>;
      print(response);
      print(jsonData);
